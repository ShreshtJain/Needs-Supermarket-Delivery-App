 ...
 */
public class AllSitesAdapter extends RecyclerView.Adapter<AllSitesAdapter.PendingRequestViewHolder> {

    private Context context;
    private List<SiteEntity> data;

    public AllSitesAdapter(Context context, List<SiteEntity> data) {
